...
export const CHAT_HEADER: string = `Start typing to interact with Kieran Bot!`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Customized AI by Kieran Amin @ UNC`;
export const CLEAR_BUTTON_TEXT: string = `Clear chat history`;
export const PAGE_TITLE: string = `Kieran's AI Bot`;
